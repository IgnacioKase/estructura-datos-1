...
Dict _tablahash_crear(int size)
{
    Dict d;
    int i;
...
Dict tablahash_crear(void)
{
    return internalDictCreate(INITIAL_SIZE);
}

void tablahash_destruir(Dict d)
{
    int i;
    struct elt *e;
    struct elt *next;
...
static void _tablahash_crecer(Dict d)
{
...
void tablahash_insertar(Dict d, const char *key, void *value)
{
    struct elt *e;
    unsigned long h;
...
void * tablahash_buscar(Dict d, const char *key)
{
    struct elt *e;
...
void tablahash_eliminar(Dict d, const char *key)
{
