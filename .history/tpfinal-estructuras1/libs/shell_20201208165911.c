...
int loop_shell(char *buf, TablaHash *tabla) {
    ...
    fprintf(archivoSalida,
          "%d,%c,%d,%c,%d,%s, %s, %s, %d, %d, %d\n", 
          actual->registro->fecha->anio, 45, actual->registro->fecha->mes,
          45, actual->registro->fecha->dia, "T00:00:00-03:00",
          actual->registro->departamento, actual->registro->localidad,
          actual->registro->confirmados, actual->registro->descartados,
          actual->registro->enEstudio, actual->registro->notificaciones);
