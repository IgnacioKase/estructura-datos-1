...
void registro_imprimir(Registro registro) {
    ...
    printf("%d-%d-%d,%s,%s,%d,%d,%d,%d\n", fecha->anio, fecha->mes, fecha->dia, registro->departamento, registro->localidad, registro->confirmados, registro->descartados, registro->en_estudio, registro->notificaciones);
}