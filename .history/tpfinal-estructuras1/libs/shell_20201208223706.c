...
void eliminar_registro(TablaHash tabla, const char *fecha, const char *departamento, const char *localidad) {
    char *clave = registro_construir_clave(departamento, localidad);
    Fecha fecha = fecha_analizar(fecha);
    Registro registro = (Registro) tablahash_buscar(tabla, clave);
