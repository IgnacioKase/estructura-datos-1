...
void graficar(TablaHash tabla, const char *fecha_inicio_char, const char *fecha_fin_char, const char *departamento, const char *localidad) {
    ...
    char * comandos_gnuplot[] = {
        "set terminal dumb set title \"Gráfica casos confirmados\"",
        "set xdata time",
        "set timefmt \"%y-%m-%d\"",
        // xrange,
        "set format x \"%y-%m-%d\"",
        ...
        "plot 'confirmados.temp' using 1:2 lt rgb 'red' w l title 'Confirmados', 'acumulados.temp' using 1:2 lt rgb 'red' w l title 'Acumulados'"
    };
