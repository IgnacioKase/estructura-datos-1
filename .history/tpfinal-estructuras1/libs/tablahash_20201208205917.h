...
typedef void (*Destruir)(void *dato, void *dato);
...
struct tablaHash {
    ...
    Destruir destruir;
    DestruirInterno DestruirInterno;
    struct elt **table;
};
...
void tablahash_destruir(TablaHash d, Destruir destruir, DestruirInterno destruir_extra));
...
void tablahash_eliminar(TablaHash d, const char *key, Destruir destruir, DestruirInterno destruir_extra));
