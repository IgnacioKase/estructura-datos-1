...
TablaHash _tablahash_crear(int size, FuncionHash fun, FuncionIgualdad igualdad, Destruir destruir, DestruirInterno destruir_interno)
{
    TablaHash d;
    int i;
...
TablaHash tablahash_crear(FuncionHash fun, FuncionIgualdad igualdad, Destruir destruir, DestruirInterno destruir_interno)
{
