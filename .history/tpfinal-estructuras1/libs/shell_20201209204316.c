...
void tiempo_duplicacion(TablaHash tabla, const char *fecha_char, const char *departamento, const char *localidad) {
    ...
    printf("El tiempo de duplicación para la localidad de: %s, fue de %d día/s, en la fecha: %d-%d-%d con un ratio de %.4f, una diferencia absoluta con el valor objetivo de %d\n.", 
            clave,
