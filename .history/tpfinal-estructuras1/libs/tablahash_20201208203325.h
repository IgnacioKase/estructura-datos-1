...
typedef void (*DestruirDato)(void *dato);
typedef void (*DestruirDatoExtra)(void *func, void *dato);
...
void tablahash_destruir(TablaHash d, Destruir destruir);

void tablahash_destruir_extra(TablaHash d, Destruir DestruirDatoExtra);
...
void tablahash_eliminar_extra(TablaHash d, const char *key, Destruir destruir_extra);
